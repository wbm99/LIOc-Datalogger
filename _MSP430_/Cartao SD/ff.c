...
#include "../Cartao SD/ff.h"			/* FatFs configurations and declarations */

#include "../Cartao SD/diskio.h"		/* Declarations of low level disk I/O functions */
...
static
FRESULT dir_find (
	DIRS *dj			/* Pointer to the directory object linked to the file name */
)
{
	FRESULT res;
	BYTE c, *dir;
