...
#include "../Cartao SD/diskio.h"             /* Common include file for FatFs and disk I/O layer */
#include "../Cartao SD/HAL_SDCard.h"         /* MSP-EXP430F5529 specific SD Card driver */
...
// CPU Frequency.
#define MCLK_FREQ   	25000000         /* Master Clock - 25MHz */
